...
Функция ЭтоФорматОтчета_10_3(ошибкиФайла) Экспорт

	результат = ошибкиФайла.Свойство("rules")
		И ТипЗнч( ошибкиФайла.rules ) = Тип("Массив")
		И ошибкиФайла.rules.Количество() > 0 И ошибкиФайла.rules[0].Свойство("id")
		И ошибкиФайла.rules[0].impacts.Количество() > 0;
