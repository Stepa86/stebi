...
Процедура ПереопределитьИдентификаторыПравил(таблицаРезультатов)
	...
	АвтоСинонимы = Новый Соответствие();
	...
	Для каждого Стр Из таблицаРезультатов Цикл
		...
		Иначе
			...
			Если ИмяПравила = Неопределено Тогда
				Если АвтоСинонимы[Стр.Правило] = Неопределено Тогда
					АвтоСинонимы[Стр.Правило] = "";
					Для каждого КЗ Из ИсточникПравил Цикл
						Если СтрНачинаетсяС(Стр.Правило, КЗ.Ключ) Тогда
							...
							Если ПустаяСтрока(КЗ.Значение) Тогда
								АвтоСинонимы[Стр.Правило]  = СтрЗаменить(Стр.Правило, КЗ.Ключ + ".", "");
							Иначе
								АвтоСинонимы[Стр.Правило]  = СтрЗаменить(Стр.Правило, КЗ.Ключ, КЗ.Значение);
							КонецЕсли;
							Прервать;
						КонецЕсли;
					КонецЦикла;
				КонецЕсли;
				Если ЗначениеЗаполнено(АвтоСинонимы[Стр.Правило]) Тогда
					Стр.Правило = АвтоСинонимы[Стр.Правило];
				КонецЕсли;
			Иначе
	...
	Если АвтоСинонимы.Количество() Тогда
		СписокЗначений = Новый СписокЗначений();
		Для каждого КЗ Из АвтоСинонимы Цикл
