...
Перем _НеРазрешатьОтносительныеПути;
...
Процедура ОписаниеКоманды(Команда) Экспорт
	...
	Команда.Опция("no_resolve_paths", Ложь, "Не разрешать относительные пути к замечаниям");
...
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
	...
	Для каждого цФайл Из _файлыОшибок Цикл
		...
		_Лог.Информация("Подготовлено к записи в джсон ошибок: %1, правил: %2", замечанияФайла.issues.Количество(), замечанияФайла.rules.Количество());
...
Процедура ИнициализацияПараметров(Знач Команда)
	...
	_НеРазрешатьОтносительныеПути = Команда.ЗначениеОпции("no_resolve_paths");
	_лог.Информация("no_resolve_paths = " + _НеРазрешатьОтносительныеПути);
...
Функция ПутьКФайлуСЗамечаниями(пОшибка, пЕстьИзменения)
	...
	Если _НеРазрешатьОтносительныеПути Тогда
		Возврат путьКФайлуСЗамечанием;
	КонецЕсли;
